...
{
    /// <summary>
    /// The <c>EventData_UnequipObject</c> class represents the data needed
    /// when the player unequip an equiped object.
    /// </summary>
    class EventData_UnequipObject : IEventData
    {
        #region Fields
        ...
        /// </summary>
        /// <value>
        /// Reference to the object to be unequiped away.
        /// </value>
        ...
        /// <summary>
        /// Constructor of the <c>EventData_UnequipObject</c> class.
        /// </summary>
        /// <param name="player">Reference to the main player.</param>
        /// <param name="newObject">Reference to the object to be unequiped.</param>
        /// <param name="inventoryScreen">Reference to the screen that contains the player inventory.</param>
        public EventData_UnequipObject(Player player, Objects.Object newObject, 
